...
pub struct AliMeeting;

impl Dataset for AliMeeting {
    ...
    fn ensure(&self, base_dir: &Path) -> Result<()> {
        ...
        // AliMeeting structure: Eval_Ali_near/audio_and_target/{session}/
        //   {session}_near.wav + {session}.TextGrid
