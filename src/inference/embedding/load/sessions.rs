        ...
        Ok(EmbeddingModel {
            ...
            ort: OrtEmbeddingState {
                ...
                split_fbank_batched_session: self
                    ...
                    .split_fbank_batched_session
                    .map(SharedSession::new),
                split_tail_session: self.ort.split_tail_session.map(SharedSession::new),
                split_tail_batched_session: self
                    .ort
                    .split_tail_batched_session
                    .map(SharedSession::new),
                split_primary_tail_batched_session: self
                    ...
                    .split_primary_tail_batched_session
                    .map(SharedSession::new),
                multi_mask_session: self.ort.multi_mask_session.map(SharedSession::new),
                multi_mask_batched_session: self
                    .ort
                    .multi_mask_batched_session
                    .map(SharedSession::new),
